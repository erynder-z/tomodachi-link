...
export default function EditUserDataModal({
    ...
    return (
        ...
        >
            <div className="relative w-11/12 lg:w-1/5 flex flex-col justify-around shadow-lg p-4 bg-card dark:bg-cardDark text-regularText dark:text-regularTextDark">
                <button
