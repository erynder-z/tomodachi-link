...
export default function ChatConversationList({
    ...
    return (
        <div className="flex md:h-fit sticky top-0 md:top-2 md:flex-col overflow-y-auto lg:overflow-hidden gap-2 lg:gap-4 w-screen md:w-full p-2 lg:p-0 bg-canvas dark:bg-canvasDark">
