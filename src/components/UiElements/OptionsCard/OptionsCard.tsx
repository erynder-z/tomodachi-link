...
export default function OptionsCard({
    ...
    return (
        <div className="flex flex-col gap-4 p-4 lg:w-full lg:flex-row lg:justify-around lg:shadow-md bg-canvas dark:bg-canvasDark text-regularText dark:text-regularTextDark">
            {toggleSidebar && (
