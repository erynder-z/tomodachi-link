...
export default function GithubLoginButton() {
    ...
    return (
        <button
            ...
            className="relative overflow-hidden w-full bg-slate-900 hover:bg-slate-700 text-white font-bold rounded transition duration-500 ease-in-out"
        >
            <div className="z-10 relative w-full flex justify-center items-center group p-2 md:p-4 text-sm md:text-lg text-white hover:text-white">
